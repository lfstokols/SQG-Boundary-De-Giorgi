...
Let $\Omega \subseteq \R^2$ be an open, bounded domain with $C^{2,\beta}$ boundary, $\beta \in (0,1)$.  Let $k > 0$ be a constant.  Then there exist constants $\alpha \in (0,1)$ such that the following holds:
