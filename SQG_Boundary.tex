...
Define $\bar{P}_j := P_{j-1} + P_j + P_{j+1}$.  Then $\bar{P}_j P_j = P_j$, and since the projections $P_i$ are spectral operators, they commute with $\Lambda^s$.  We therefore rewrite
