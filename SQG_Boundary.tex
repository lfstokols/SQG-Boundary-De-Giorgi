...
\[ |\dot{\gamma}_k(t)| \leq 2 \eps \kappa |\gamma_k(t)| - \kappa \log_2(\eps). \]
This, by Gronwall's inequality, tells us that for $t \in [-5,0]$,
\[ |\gamma_k(t)| \leq \frac{-\log_2(\eps)}{2 \eps} \paren{ e^{10 \eps \kappa} - 1} \]
and hence
\[ |\dot{\gamma}_k(t)| \leq -\kappa \log_2(\eps) e^{10\eps \kappa}. \]

To account for $\gamma_0$, define
\[ \Cgamma = \max\paren{ - \kappa \log_2(\eps) e^{10\eps\kappa}, j_0 \kappa} \]
