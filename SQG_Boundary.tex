...
\\ & \hskip2cm + k^2 \int_0^T\!\!\!\!\int \indic{\theta_+>0} + \int_0^T\! \abs{\int \theta_+ \paren{\del_t \Psi + u\cdot\grad\Psi}} \bigg).
\end{aligned}
%\begin{aligned}
...
%Applying these two bounds to the integral from $S$ to $T$ of \eqref{equality with varphi}, we obtain
%\[\begin{aligned} 
%\frac{-1}{2} \int_S^T\!\!\int \theta_+^2 \del_t \varphi &\leq \frac{1}{2} \int_S^T\!\!\int  \theta_+^2 u \cdot \grad \varphi - \int_S^T\!\!\int \varphi \theta_+ \paren{\del_t \Psi + u \cdot \grad \Psi} 
%\\ &+ C \norm{\varphi}_{C^0(S,T;C^1)} \paren{ (1+S\n) \int_0^T\!\!\int \theta_+^2 + k^2 \int_0^T\!\!\int \indic{\theta_+>0} + \int_0^T\!\! \abs{\int \theta_+ \paren{\del_t \Psi + u\cdot\grad\Psi}}}.
%\end{aligned}\]
