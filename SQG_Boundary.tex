...
This problem was considered by Constantin and Ignatova in \cite{CoIg.fraclap} and \cite{CoIg.fraclap}, showing existence of weak solutions and interior regularity for smooth solutions, respectively.  The method of proof for interior regularity is by nonlinear maximum principles, formulas derived from the pointwise Cordoba-Cordoba inequality which allow us to control the dissipation of solutions near spatial maxima.  However, the bounds blow up near the boundary and so the method seems inapplicable to the question of global regularity.  
