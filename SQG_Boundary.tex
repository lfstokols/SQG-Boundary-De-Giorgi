...
Constructing the paths $\Gamma$ and $\gamma$ must wait until Section~\ref{sec:holder}, but we can state now how to obtain the functions $\ulow$ and $\uhigh$ from a calibrated $u$.  
